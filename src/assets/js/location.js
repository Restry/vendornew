...
var provinceHtml = '<div class="content"><div data-widget="tabs" class="m egc-stock" id="egc-stock">'
								+'<div class="mt">'
								+'    <ul class="tab">'
...
var areaTabContainer=$("#egc-stock .tab li");
...
(function(){
	$("#store-selector").unbind("mouseover").bind("mouseover",function(){
		...
		$("#store-selector .content,#egc-stock").show();
	}).find("dl").remove();
	CurrentAreaInfoInit();
